...
import { CreateInstructionSpComponent } from '../create-instruction-sp/create-instruction-sp.component';
...
export class InstructionsSpComponent implements OnInit {
  ...
  AddInstruction(){
    ...
    const dialogRef = this.dialog.open(CreateInstructionSpComponent, {
      width: '350px',
      height: '300px'
